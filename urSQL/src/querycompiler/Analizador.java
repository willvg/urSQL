...
public class Analizador {
    ...
    public boolean Frase_alter(ArrayList<String> frase_entrada) {
        if (frase_entrada.get(1).equals("TABLE")
                &&frase_entrada.get(3).equals("ADD")
                && frase_entrada.get(4).equals("CONSTRAINT")
                && frase_entrada.get(5).equals("FOREING")
                && frase_entrada.get(6).equals("KEY")
                && frase_entrada.get(10).equals("REFERENCES")
                && frase_entrada.get(12).equals("(")
                && frase_entrada.get(14).equals(");")) {
            return true;
        } else {
            return false;
        }
    }
    //ALTER/TABLE/prueba/ADD/CONSTRAINT/FOREING/KEY/(/nombre/)/REFERENCES/prueba/(/columna/);/
    ...
    /**
     * Frase_index valida la estructura del comando a ingresar que es CREATE
     * INDEX
     *
     * @param frase_entrada
     * @return boolean
    ...
    //Comando DML//
    /**
     * For_where lo que realiza es que valida si se encuentra un INNER JOIN en
